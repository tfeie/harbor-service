...
public class QueryMyJointGoReq implements Serializable {

	private static final long serialVersionUID = 1L;

	@NotNull(message = "用户为空", groups = { IGoSV.QueryMyJointGoes.class })
	private String userId;

	@NotNull(message = "活动分类为空", groups = { IGoSV.QueryMyGoes.class })
	@StringEnum(enumClazz = GoType.class, message = "活动分类传入不合规", groups = { IGoSV.QueryMyJointGoes.class })
