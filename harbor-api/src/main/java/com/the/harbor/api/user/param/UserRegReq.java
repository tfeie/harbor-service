...
public class UserRegReq implements Serializable {
     ...
     * 英文名
     */
    @NotBlank(message = "请输入英文名", groups = { IUserSV.UserRegister.class })
    private String enName;

    /**
     * 性别
     */
    @NotBlank(message = "请选择性别", groups = { IUserSV.UserRegister.class })
     ...
     * 留学国家
     */
    @NotBlank(message = "请选择留学国家", groups = { IUserSV.UserRegister.class })
    private String abroadCountry;

    /**
     * 留学大学
     */
    @NotBlank(message = "请输入留学大学", groups = { IUserSV.UserRegister.class })
