...
public class UserCommentListener implements InitializingBean {

	private static final Logger LOG = LoggerFactory.getLogger(UserCommentListener.class);
